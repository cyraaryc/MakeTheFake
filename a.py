...
hw_total = float(4*sum(hw_scores) - 3*min(hw_scores))/float(4*num_hw - 3) # normalize hw scores, obtained by downweighting worst hw to one-fourth. Total is out of 100
print(hw_total)
